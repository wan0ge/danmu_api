...
export class Envs {
  ...
  static resolveEpisodeTitleFilter() {
    const defaultFilter = 
      // 基础物料：企划、Vlog、预告、花絮、纯享
      '(特别|惊喜|纳凉)?企划|合伙人手记|超前(营业|vlog)?|速览|vlog|reaction|纯享|加更(版|篇)?|抢先(看|版|集|篇)?|抢鲜|预告|花絮(独家)?|' +
      // 特辑/彩蛋/专访：限定前缀防误杀 (如：行动彩蛋、专访嫌疑人)
      ...
      // 直播/解读/精华：防误杀剧情 (如：直播犯罪、解读密文、生命精华)
      '直播(陪看|回顾)?|直播(?!(.*(事件|杀人|自杀|谋杀|犯罪|现场|游戏|挑战)))|未播(片段)?|衍生|番外|会员(专享|加长|尊享|专属|版)?|片花|' +
      '(?<!(提取|吸收|生命|魔法|修护|美白))精华|看点|速看|解读(?!.*(密文|密码|密电|电报|档案|书信|遗书|碑文|代码|信号|暗号|讯息|谜题|人心|唇语|真相|谜团))|' +
      // 影评/盘点/各类花絮：防误杀商务词 (如：财务盘点)
      '影评|解说|吐槽|(?<!(年终|季度|库存|资产|物资|财务))盘点|拍摄花絮|制作花絮|幕后花絮|未播花絮|独家花絮|花絮特辑|' +
      '先导预告|终极预告|正式预告|官方预告|彩蛋片段|删减片段|未播片段|番外彩蛋|精彩片段|精彩看点|精彩回顾|精彩集锦|看点解析|看点预告|NG镜头|NG花絮|' +
      // 音乐/回顾/访谈/插曲：防误杀生活词 (如：生活插曲)
      ...
      // 衍生版本/短片/综艺局 & “局”字逻辑 (排除市局/结局等)
      '试看版|短剧|精编|Plus|独家版|特别版|短片|发布会|解忧局|走心局|火锅局|巅峰时刻|坞里都知道|福持目标坞民|(福利|加更|番外|彩蛋|衍生|特别|收官|游戏|整蛊|日常)篇|' +
      '(?!.*(市局|分局|警局|总局|省局|卫局|药局|政局|监局|结局|大局|开局|破局|布局|僵局|困局|骗局|赌局|胜局|败局|定局|乱局|危局|迷局|入局|搅局|设局|中局|残局|平局|和局)).{2,}局|' +
      // 观察室/纪录片/其他：防误杀医疗刑侦词 (如：重症观察室、刑侦全纪录)
      '(?<!(重症|隔离|实验|心理|审讯|单向|术后))观察室|上班那点事儿|周top|赛段|直拍|REACTION|VLOG|(?<!(大案|要案|刑侦|侦查|破案|档案|风云|历史|战争|探案))全纪录|' +
      '开播|先导|总宣|展演|集锦|旅行日记|精彩分享|剧情揭秘';
