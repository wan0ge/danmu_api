...
如果没有找到合适的匹配，返回：
{
  ...
  static load(env = {}) {
    ...
    const envVarConfig = {
	  ...
	  'REAL_TIME_PULL_DANDAN': { category: 'source', type: 'boolean', description: '弹弹第三方弹幕源实时拉取开关，默认开启' },
    ...
    return {
	  ...
	  realTimePullDandan: this.get('REAL_TIME_PULL_DANDAN', true, 'boolean'), // 弹弹第三方弹幕源实时拉取开关
