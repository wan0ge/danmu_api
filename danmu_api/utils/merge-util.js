...
//  [L9] 核心匹配层          —— 上下文感知、集内容探测、副源检索
//  [L10] 合并业务流程层     —— 合集探测、单任务执行
//  [L11] 主入口             —— applyMergeLogic (三段式 Phase)
 ...
 *   2. 各类冲突检测（媒体类型、之字结构、剧场版、日期、季度）
 *   3. 主副别名交叉比对 + 综合相似度计算
 *   4. 集内容 Probe（可覆盖相似度）
 *   5. Tier 筛选（中文优先、Part 宽松）
 *
 * @param {Object} primaryAnime        - 主源番剧对象
